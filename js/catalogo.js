	...
	$.ajax({
		...
		success:function(respuesta){
			...
			for (var i = 0; i<respuesta.length; i++) {
                $("#obtenerProductos").append('<div class="col-md-4 product-block"><div class="col-md-12 home-grid"><div class="home-product-main"><div class="home-product-top"><a href="single.html"><img src="images/h5.jpg" alt="" class="img-responsive zoom-img"></a></div><div class="home-product-bottom"><h3><a href="single.html">'+respuesta[i].nombre+'</a></h3><p>'+respuesta[i].descripcion+'</p></div><div class="srch"><span>Lps. '+respuesta[i].precio+'</span></div></div></div><div class="clearfix"> </div></div>');
			}
		}
	});
});